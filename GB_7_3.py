...
class Cell:
    ...
    def __add__(self, other):
        return f'Результат = {str(Cell(self.quantity + other.quantity))}'

    def __sub__(self, other):
        if (self.quantity - other.quantity) > 0:
            return f'Результат = {Cell(int(self.quantity - other.quantity))}'
    ...
    def __truediv__(self, other):
        return f'Результат = {Cell(round(self.quantity // other.quantity))}'
...
print(f"Создаем объекты клеток {cell1} и {cell2} \n")
...
print(f'Для клетки {cell1} - {cell1.make_order(5)}')
print(f'Для клетки {cell2} - {cell2.make_order(5)}')
